...
Gem::Specification.new do |spec|
  spec.name = "jp_address"
  spec.version = JpAddress::VERSION
  ...
  spec.homepage = "https://github.com/wagai/jp_address"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.2.0"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/wagai/jp_address"
  spec.metadata["changelog_uri"] = "https://github.com/wagai/jp_address/blob/main/CHANGELOG.md"
